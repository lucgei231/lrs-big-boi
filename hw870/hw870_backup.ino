...
void setup(){
  ...
  Serial.println("BLE initialized! Advertising as 'Lucas_Robot'");
  Serial.println("Waiting for Micro:bit connection...");
...
void loop() {
  ...
  ArduinoOTA.handle();
  server.handleClient();
  handleMicrobitCommands();  // Check BLE status
